...
public class PembayaranAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Produk> dataItemList;
    //utk membedakan xml

    public PembayaranAdapter(List<Produk> dataItemList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ((Penampung)holder).txtnama.setText("Namanya   : " + dataItemList.get(position).getNamaProduk());
        ((Penampung)holder).txtdeskripsi.setText("Alamatnya   : " + dataItemList.get(position).getDeskripsiProduk());
        ((Penampung)holder).txtharga.setText("Umurnya   : " + (String.valueOf(dataItemList.get(position).getHarga())));
