...
public class ModelTopup implements Serializable, Parcelable
{
    ...
    public final static Creator<ModelTopup> CREATOR = new Creator<ModelTopup>() {
    ...
    ;
    private final static long serialVersionUID = 8872386627833966070L;
